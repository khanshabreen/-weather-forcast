           ...
           var apiUrl = `https://www.7timer.info/bin/api.pl?lon=${longitude}&lat=${latitude}&product=astro&output=xml`;
            ...
            fetch(apiUrl)
              ...
              let currentDate = `${day}-${month}-${year}`;
                ...
                if (dataElement) {
                    var divElement = document.getElementById(divr[i]); 
                    ...
                    var dataDiv = document.createElement('div');
                       if(cloudcover<3) 
                       {
                        ...
                        <p ><b>${currentDate}</p></b>
                        <img src="img/clear.png" alt="clear"/></img>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/pcloudy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/mcloudy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/cloudy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/fog.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/rain.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/oshower.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/ishower.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/snow.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/rainsnow.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/tsrain.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/tstrom.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="img/windy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
